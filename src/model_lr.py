...
from lib.config import LR_C_VALUES, LR_CLASS_WEIGHT, LR_MAX_ITER, RANDOM_STATE, ZERO_DIVISION
...
for C in LR_C_VALUES:
    ...
    f1_macro = f1_score(y_test, y_pred_tmp, average='macro', zero_division=ZERO_DIVISION)
    f1_wtd = f1_score(y_test, y_pred_tmp, average='weighted', zero_division=ZERO_DIVISION)
